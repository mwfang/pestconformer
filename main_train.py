...
def get_args_parser():
    parser = argparse.ArgumentParser('PestConformer for Crop Pest classification', add_help=False)
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='./checkpoint/convmae_base.pth',
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='./data/IP102', type=str,
                        help='dataset path')
...
def main(args):
    ...
    #print('class_id:',dataset_train.class_to_idx)
